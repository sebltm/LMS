...
int IO::recordCallback (const void                         *inputBuffer,
                           void                            *outputBuffer,
...
int IO::playCallback(const void *inputBuffer,
                        void *outputBuffer,
                        unsigned long framesPerBuffer,
                        const PaStreamCallbackTimeInfo* timeInfo,
                        PaStreamCallbackFlags statusFlags,
